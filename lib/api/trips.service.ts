...
export type TripResponse = {
    id: string; title: string | null; seats: number | null; priceMga: number | null; departureAt: string | null; arrivalAt: string | null;
    start: LatLngDto; end: LatLngDto; path: LatLngDto[]; driver: { uid: string; firstName: string | null; lastName: string | null };
};
...
export async function searchTrips(input: {
    start: LatLngDto; end: LatLngDto; radiusMeters?: number; minCoverage?: number; limit?: number;
}) {
